...
for(const [oldIndex,id] of campaign.REVISION_TEN_QUEST_IDS.entries()){
 ...
 const g=new GameEngine(restoreState(raw));assert.equal(g.q.id,({e06_rest:'e06_first_interlude',e05:'e04_homecoming',g14:'g14_dock_report',g13:'g13_hut',g16:'g15_escape',g18:'g17_manor',g20:'g19_return',g22:'g21_return',g24:'g23'})[id]||id,id+' keeps its numeric identity or explicit migration');assert.deepEqual(resources(g),resources({s:raw}));legacyCases++;
}
