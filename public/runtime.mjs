...
export class GameEngine{
 ...
 travelBlocked(){return !!this.jump||!!this.s.failure||this.paused||['battle','escape','staging'].includes(this.s.phase)||(['search','return'].includes(this.s.phase)&&this.q.timeLimit);}
 travel(id){
