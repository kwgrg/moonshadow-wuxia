...
export class GameEngine{
 ...
 get companion(){const mainName=this.s.phase==='choice'?(this.q.choiceSpeaker||this.q.npc):this.q.npc,hasMainActor=this.s.map===this.q.map&&['talk','after','choice','return'].includes(this.s.phase)&&!this.canStartStaging()&&mainName===this.s.flags.companion;return !hasMainActor&&!this.q.hideCompanion&&!this.stagingActors().some(actor=>actor.name===this.s.flags.companion)&&this.s.flags.companion&&!this.s.completed&&this.s.flags.companion!==this.q.playAs?{x:this.followPosition.x,y:this.followPosition.y,name:this.s.flags.companion,sprite:this.s.flags.companion==='紫轩'?2:1,direction:this.s.hero.direction}:null;}
 get searchPoints(){
