...
export class GameEngine{
 ...
 get scene(){
  ...
  let scene=getScene(this.s.map,this.region,aftermath?'towerAftermath':undefined);
 ...
 travelBlocked(){return !!this.jump||!!this.s.failure||this.paused||(this.s.phase==='battle'&&!this.rescueReady()&&!this.towerCanTravel())||['escape','staging'].includes(this.s.phase)||(['search','return'].includes(this.s.phase)&&this.q.timeLimit);}
 travel(id){
...
Object.assign(GameEngine.prototype,towerMethods,combatMethods,stagingMethods,recruitmentMethods,skirmishMethods,pursuitMethods,rescueMethods);
